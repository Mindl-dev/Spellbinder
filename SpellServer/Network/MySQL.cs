...
namespace SpellServer
{
    ...
    public static class ServerSettings
	    ...
	    public static class Character
	    {
			...
			public static Boolean Save(SpellServer.Character character, Boolean isNew, PlayerFlag flags)
			{
				try
				{
					...
					using (MySqlConnection sqlConnection = new MySqlConnection(ConnectionString))
					{
						...
						if (sqlConnection.State == ConnectionState.Open)
						{
                            ...
                            sqlCommand.Parameters.AddWithValue("@spell_key_13", character.SpellKey13);
                            sqlCommand.Parameters.AddWithValue("@spell_key_14", character.SpellKey14);
                            sqlCommand.Parameters.AddWithValue("@spell_key_15", character.SpellKey15);
                            sqlCommand.Parameters.AddWithValue("@spell_key_16", character.SpellKey16);
                            sqlCommand.Parameters.AddWithValue("@spell_key_17", character.SpellKey17);
                            sqlCommand.Parameters.AddWithValue("@spell_key_18", character.SpellKey18);
                            sqlCommand.Parameters.AddWithValue("@spell_key_19", character.SpellKey19);
                            sqlCommand.Parameters.AddWithValue("@spell_key_20", character.SpellKey20);
                            sqlCommand.Parameters.AddWithValue("@spell_key_21", character.SpellKey21);
                            sqlCommand.Parameters.AddWithValue("@spell_key_22", character.SpellKey22);
                            sqlCommand.Parameters.AddWithValue("@spell_key_23", character.SpellKey23);
                            sqlCommand.Parameters.AddWithValue("@spell_key_24", character.SpellKey24);
                            sqlCommand.Parameters.AddWithValue("@spell_key_25", character.SpellKey25);
                            sqlCommand.Parameters.AddWithValue("@spell_key_26", character.SpellKey26);
                            sqlCommand.Parameters.AddWithValue("@spell_key_27", character.SpellKey27);
                            sqlCommand.Parameters.AddWithValue("@spell_key_28", character.SpellKey28);
                            sqlCommand.Parameters.AddWithValue("@spell_key_29", character.SpellKey29);
                            sqlCommand.Parameters.AddWithValue("@spell_key_30", character.SpellKey30);
                            sqlCommand.Parameters.AddWithValue("@spell_key_31", character.SpellKey31);
                            sqlCommand.Parameters.AddWithValue("@spell_key_32", character.SpellKey32);
                            sqlCommand.Parameters.AddWithValue("@spell_key_33", character.SpellKey33);
                            sqlCommand.Parameters.AddWithValue("@spell_key_34", character.SpellKey34);
                            sqlCommand.Parameters.AddWithValue("@spell_key_35", character.SpellKey35);
                            sqlCommand.Parameters.AddWithValue("@spell_key_36", character.SpellKey36);
                            sqlCommand.Parameters.AddWithValue("@spell_key_37", character.SpellKey37);
