...
namespace SpellServer
{
    public class ArenaTeamCollection : ListCollection<ArenaTeam>
    {
        ...
        {
            Add(new ArenaTeam(grid.DragonShrine));
            Add(new ArenaTeam(grid.GryphonShrine));
            Add(new ArenaTeam(grid.PheonixShrine));
        }
