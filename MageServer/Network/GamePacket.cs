...
using MageServer.GamePacket.Incoming;
using MageServer.GamePacket.Outgoing;
...
namespace MageServer
{
    ...
    namespace GamePacket
    {
        namespace Incoming
        {
            ...
            {
                public static void Jump(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                ...
                public static void God(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null || !player.IsAdmin) return;
                ...
                public static void Yank(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null || !player.IsAdmin) return;
                ...
                public static void PlayerMoveState(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                ...
                public static void PlayerMoveStateShort(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null || player.Flags.HasFlag(PlayerFlag.Hidden)) return;
                ...
                public static void CalledGhost(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void BiasedPool(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void BiasedShrine(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void CastEffect(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void CastTargeted(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void CastRune(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void CastBolt(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void CastProjectile(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void CastWall(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void CastDispell(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                    ...
                    if (wall == null)
                    {
                        if (player.ActiveCharacter.Class == MageServer.Character.PlayerClass.Runemage)
                        {
                ...
                public static void ThinDamage(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void ActivatedTrigger(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
            ...
            {
                public static void Save(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    MageServer.Character.Save(player, new MageServer.Character(inStream));
                }
                public static void Delete(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
            ...
            {
                public static void Authenticate(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
            ...
            public static class Player
            {
                ...
                public static void EstablishDatagram(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                ...
                public static void Heartbeat(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                ...
                public static void HasEnteredWorld(MageServer.Player player, bool UDP = false)
                {
                    Network.Send(player, Outgoing.Player.HasEnteredWorld());
                }
                public static void EnterWorld(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                ...
                public static void ExitWorld(MageServer.Player player, bool UDP = false)
                {
                    if (player.ActiveArena == null || player.ActiveArenaPlayer == null) return;
                ...
                public static void Chat(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                ...
                public static void SwitchedToTableOrArena(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    inStream.Seek(5, SeekOrigin.Begin);
            ...
            {
                public static void RequestCharacterInSlot(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                ...
                public static void IsNameTaken(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                ...
                public static void IsNameValid(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    Byte[] tBuffer = new Byte[12];
                    inStream.Seek(2, SeekOrigin.Current);
                    inStream.Read(tBuffer, 0, 12);
                ...
                public static void HighScores(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    inStream.Seek(5, SeekOrigin.Begin);
            ...
            {
                public static void RequestedPlayer(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    Byte[] tBuffer = new Byte[2];
                    inStream.Seek(4, SeekOrigin.Begin);
                ...
                public static void RequestedAllPlayers(MageServer.Player player, bool UDP = false)
                {
                ...
                public static void RequestedArena(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    inStream.Seek(5, SeekOrigin.Begin);
                ...
                public static void RequestedAllArenas(MageServer.Player player, bool UDP = false)
                {
                    MemoryStream outStream = null;
                    Int32 j = 0;
                ...
                public static void RequestedArenaStatus(MageServer.Player player, bool UDP = false)
                {
                ...
                public static void CreateTable(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    inStream.Seek(2, SeekOrigin.Begin);
                ...
                public static void RequestedAllTables(MageServer.Player player, bool UDP = false)
                {
                ...
                public static void CreateArena(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    inStream.Seek(2, SeekOrigin.Begin);
                    ...
                    if (grid != null)
                    {
                        ...
                        {
                            new MageServer.Arena(player, grid, levelRange, new ArenaRuleset(ArenaRuleset.ArenaMode.TwoTeams));
                        }
                    }
                }
                public static void DeleteArena(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    inStream.Seek(2, SeekOrigin.Begin);
                ...
                public static void RequestEnterLarge(MageServer.Player player)
                {
            ...
            {
                public static void HackNotification(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    inStream.Seek(2, SeekOrigin.Begin);
                ...
                public static void CheatProgramNotification(MageServer.Player player, MemoryStream inStream, bool UDP = false)
                {
                    inStream.Seek(2, SeekOrigin.Begin);
        ...
        namespace Outgoing
        {
            public static class Arena
            {
                ...
                public static MemoryStream UpdateShrinePoolState(MageServer.Arena arena, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
            ...
            public static class Login
            {
                public static MemoryStream Connected(MageServer.Player player, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
            ...
            public static class Player
            {
                public static MemoryStream SendPlayerId(MageServer.Player player, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                ...
                public static MemoryStream HeartbeatReply(MageServer.Player player, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                ...
                public static MemoryStream SaveSuccess(MageServer.Player player, Byte slot, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                ...
                public static MemoryStream SwitchedToTable(MageServer.Player player, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                ...
                public static MemoryStream Chat(MageServer.Player player, Int16 target, ChatType targetType, String message, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                ...
                public static MemoryStream EstablishDatagram(MageServer.Player player, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                    ...
                    byte[] portBytes = BitConverter.GetBytes(MageServer.Properties.Settings.Default.UDPPort);
            ...
            public static class Study
            {
                public static MemoryStream IsNameValid(MageServer.Player player, String name, Boolean valid, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                ...
                public static MemoryStream IsNameTaken(MageServer.Player player, String name, Boolean taken, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                ...
                public static MemoryStream SendCharacterInSlot(MageServer.Player player, Byte slot, DataTable data, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
            ...
            {
				public static void PlaySoundToArena(MageServer.Arena arena, GameSound.Sound sound, bool UDP = false)
                {
                    if (arena == null) return;
                ...
                public static MemoryStream DirectTextMessage(MageServer.Player player, String message, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                    outStream.WriteByte((Byte)PacketOutFunction.Chat);
            ...
            public static class World
            {
                public static MemoryStream SpawnPlayer(MageServer.Player player, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                ...
                public static MemoryStream PlayerJoin(MageServer.Player player, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                ...
                public static MemoryStream PlayerLeave(MageServer.Player player, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte((Byte) player.PlayerId);
                    outStream.WriteByte((Byte)PacketOutFunction.PlayerLeave);
                ...
                public static MemoryStream PlayerEnterLarge(MageServer.Player player, MemoryStream outStream, bool UDP = false)
                {
                ...
                public static MemoryStream WorldEnterLarge(MageServer.Arena arena, MemoryStream outStream, bool UDP = false)
                {
                ...
                public static MemoryStream ArenaCreated(MageServer.Arena arena, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                ...
                public static MemoryStream ArenaState(MageServer.Arena arena, MageServer.Player player, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                ...
                public static MemoryStream ArenaForceEndState(MageServer.Arena arena, MageServer.Player player, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
                    outStream.WriteByte((Byte)PacketOutFunction.ArenaState);
                ...
                public static MemoryStream ArenaDeleted(MageServer.Arena arena, bool UDP = false)
                {
                    MemoryStream outStream = new MemoryStream();
                    outStream.WriteByte(0x00);
